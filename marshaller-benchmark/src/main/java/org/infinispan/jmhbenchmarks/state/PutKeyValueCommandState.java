...
public class PutKeyValueCommandState {
    ...
    private ResettableInputStream putKeyValuecommandStream;
    ...
    public void setup(InfinispanHolder holder, UserState userState) throws Exception {
        ...
        putKeyValuecommandStream = new ResettableInputStream(putKeyValueCommandBytes, putKeyValueCommandBytes.length);
    }
   ...
   public ResettableInputStream getPutKeyValuecommandStream() {
       putKeyValuecommandStream.restart();
      return putKeyValuecommandStream;
   }
}
